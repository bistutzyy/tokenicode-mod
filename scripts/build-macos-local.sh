...
export APPLE_SIGNING_IDENTITY="[REDACTED_APPLE_SIGNING_IDENTITY]"
export APPLE_ID="[REDACTED_APPLE_ID]"
export APPLE_PASSWORD="[REDACTED_APPLE_APP_PASSWORD]"
export APPLE_TEAM_ID="[REDACTED_APPLE_TEAM_ID]"
export TAURI_SIGNING_PRIVATE_KEY
TAURI_SIGNING_PRIVATE_KEY="$(cat "$HOME/.tauri/tokenicode.key")"
export TAURI_SIGNING_PRIVATE_KEY_PASSWORD="[REDACTED_TAURI_PASSPHRASE]"
