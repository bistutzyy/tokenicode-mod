...
const messages: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    'feedback.subtitle': 'Found a bug or have a suggestion? Tell us directly — your description will be sent to the dev team along with diagnostic info.',
    'feedback.descriptionPlaceholder': 'Describe the issue or suggestion — the more specific the better (you can paste screenshots)',
    'feedback.pasteHint': 'Paste screenshots with Ctrl/Cmd+V',
    'feedback.addScreenshot': 'Add screenshot',
    'feedback.removeScreenshot': 'Remove screenshot',
    'feedback.contactPlaceholder': 'Contact info (optional) — email / WeChat / Lark',
    ...
    'feedback.notConfigured': 'Feedback feature is not configured in this build. Please contact the developer or wait for the next release.',
