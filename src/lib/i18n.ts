...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    // === 二创新增 (TOKENICODE-recreate: 识图/用量/项目) ===
    // Sidebar projects
    'sidebar.projects': '项目',
    'sidebar.projectsEmpty': '暂无项目，点 + 添加',
    'sidebar.addProject': '添加项目文件夹',
    'sidebar.revealProject': '在文件管理器中显示',
    // InputBar vision
    'input.imageDescription': '图片预描述',
    'input.describing': '正在生成图片描述...',
    'input.described': '已生成图片描述',
    // Settings — vision tab
    'settings.tab.vision': '识图',
    'settings.vision.desc': '配置双模型识图：主模型（经 CLI）无视觉能力时，由千问 VL 在前端生成图片文字预描述并注入 prompt。凭据明文存储于 ~/.tokenicode/vision-credentials.json。',
    'settings.vision.qwenSection': '千问 VL（DashScope）',
    'settings.vision.qwenApiKey': 'API Key',
    'settings.vision.qwenApiKeyPlaceholder': 'sk-...',
    'settings.vision.qwenVlModel': 'VL 模型',
    'settings.vision.enabled': '启用',
    'settings.vision.volcSection': '火山引擎',
    'settings.vision.volcReserved': '（预留）',
    'settings.vision.volcAk': 'Access Key',
    'settings.vision.volcSk': 'Secret Key',
    'settings.vision.save': '保存',
    'settings.vision.saving': '保存中...',
    'settings.vision.saved': '已保存',
    'settings.vision.testBalance': '查询余额',
    'settings.vision.testing': '查询中...',
    'settings.vision.balanceOk': '余额',
    'settings.vision.balanceFail': '余额查询暂不可用',
    'settings.vision.prefillHint': '已从通义千问 provider 预填 API Key，保存后生效。',
    'settings.vision.showSecrets': '显示密钥',

    // Profile stats modal (avatar-click)
    'profilestats.title': '个人资料',
    'profilestats.close': '关闭',
    'profilestats.subtitle': '本机 TOKENICODE 使用汇总',
    'profilestats.loading': '正在读取本机会话统计...',
    'profilestats.error': '读取统计失败：',
    'profilestats.totalTokens': '累计 Token 数',
    'profilestats.peakDay': '峰值日 Token 数',
    'profilestats.sessions': '会话总数',
    'profilestats.activeDays': '活跃天数',
    'profilestats.dayUnit': '天',
    'profilestats.messages': '消息计数',
    'profilestats.tokenActivity': 'Token 活动',
    'profilestats.daily': '每日',
    'profilestats.weekly': '每周',
    'profilestats.total': '累计',
    'profilestats.insights': '活动洞察',
    'profilestats.noActivity': '还没有可统计的 token 活动。',
    'profilestats.inputTokens': '输入 Token',
    'profilestats.cacheTokens': '缓存 Token',
    'profilestats.outputTokens': '输出 Token',
    'profilestats.topModels': '常用模型',
    'profilestats.responses': '次响应',
    'profilestats.noModels': '还没有模型使用记录。',
    'profilestats.refresh': '刷新统计',
    'profilestats.qwenBalance': '千问余额',
    'profilestats.balanceUnavailable': '余额查询暂不可用',
    'profilestats.avatarHint': '点击查看用量统计',
    ...
    'preview.snapshot': '捕获快照',
    'preview.snapshotShort': '快照',
    'preview.snapshotEmpty': '未捕获到可读文本',
    'preview.crossOriginSnapshot': '跨域页面无法捕获内容',
    'preview.snapshotReady': '快照已就绪',
    'preview.loading': '加载中…',
    'preview.loadFailed': '加载失败',
    'preview.empty': '输入网址开始预览',
    'preview.urlPlaceholder': '输入网址或搜索词',
  ...
  en: {
    ...
    // === recreate additions (vision / usage / projects) ===
    'sidebar.projects': 'Projects',
    'sidebar.projectsEmpty': 'No projects yet — click + to add',
    'sidebar.addProject': 'Add project folder',
    'sidebar.revealProject': 'Reveal in file manager',
    'input.imageDescription': 'Image pre-description',
    'input.describing': 'Generating image description...',
    'input.described': 'Image description ready',
    'settings.tab.vision': 'Vision',
    'settings.vision.desc': 'Dual-model vision: when the main model (via CLI) lacks vision, Qwen VL generates a textual image pre-description in the backend and injects it into the prompt. Credentials are stored as plaintext at ~/.tokenicode/vision-credentials.json.',
    'settings.vision.qwenSection': 'Qwen VL (DashScope)',
    'settings.vision.qwenApiKey': 'API Key',
    'settings.vision.qwenApiKeyPlaceholder': 'sk-...',
    'settings.vision.qwenVlModel': 'VL Model',
    'settings.vision.enabled': 'Enabled',
    'settings.vision.volcSection': 'Volces',
    'settings.vision.volcReserved': '(reserved)',
    'settings.vision.volcAk': 'Access Key',
    'settings.vision.volcSk': 'Secret Key',
    'settings.vision.save': 'Save',
    'settings.vision.saving': 'Saving...',
    'settings.vision.saved': 'Saved',
    'settings.vision.testBalance': 'Query balance',
    'settings.vision.testing': 'Querying...',
    'settings.vision.balanceOk': 'Balance',
    'settings.vision.balanceFail': 'Balance query unavailable',
    'settings.vision.prefillHint': 'API Key prefilled from the Qwen provider — save to apply.',
    'settings.vision.showSecrets': 'Show secrets',

    // Profile stats modal (avatar-click)
    'profilestats.title': 'Profile',
    'profilestats.close': 'Close',
    'profilestats.subtitle': 'Local TOKENICODE usage summary',
    'profilestats.loading': 'Loading session stats...',
    'profilestats.error': 'Failed to load stats: ',
    'profilestats.totalTokens': 'Total tokens',
    'profilestats.peakDay': 'Peak day tokens',
    'profilestats.sessions': 'Sessions',
    'profilestats.activeDays': 'Active days',
    'profilestats.dayUnit': 'days',
    'profilestats.messages': 'Messages',
    'profilestats.tokenActivity': 'Token activity',
    'profilestats.daily': 'Daily',
    'profilestats.weekly': 'Weekly',
    'profilestats.total': 'Total',
    'profilestats.insights': 'Activity insights',
    'profilestats.noActivity': 'No token activity yet.',
    'profilestats.inputTokens': 'Input tokens',
    'profilestats.cacheTokens': 'Cache tokens',
    'profilestats.outputTokens': 'Output tokens',
    'profilestats.topModels': 'Top models',
    'profilestats.responses': 'responses',
    'profilestats.noModels': 'No model usage yet.',
    'profilestats.refresh': 'Refresh',
    'profilestats.qwenBalance': 'Qwen balance',
    'profilestats.balanceUnavailable': 'Balance query unavailable',
    'profilestats.avatarHint': 'Click to view usage stats',
    ...
    'preview.snapshot': 'Capture snapshot',
    'preview.snapshotShort': 'Snapshot',
    'preview.snapshotEmpty': 'No readable text captured',
    'preview.crossOriginSnapshot': 'Cross-origin page — content not accessible',
    'preview.snapshotReady': 'Snapshot ready',
    'preview.loading': 'Loading…',
    'preview.loadFailed': 'Failed to load',
    'preview.empty': 'Enter a URL to start previewing',
    'preview.urlPlaceholder': 'Enter URL or search term',
